...
REQUIRED_SPECS=(
    ...
    "specs/018-interactive-screencast-tutor-relay/spec.md"
    "specs/018-interactive-screencast-tutor-relay/plan.md"
    "specs/018-interactive-screencast-tutor-relay/tasks.md"
)
