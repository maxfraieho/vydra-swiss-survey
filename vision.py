...
class GemmaVision:
    ...
    def decide_action(self, image_path: str, system_prompt: str, step_no: int) -> dict:
        instruction = (
            ...
            "Під час проходження опитування: обирай змістовну відповідь або Continuer. "
            "Категорично заборонено обирати 'Autre' / 'Other' / 'Інше' / 'None', якщо доступні реальні варіанти по темі опитування — завжди обирай змістовні варіанти за персоною. "
            "НІКОЛИ не обирай Continuer, якщо на скріншоті питання ще не має обраної відповіді. Якщо опитування завершено — action=\"done\". "
