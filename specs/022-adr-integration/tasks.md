...
- [ ] T-307: Додати підрозділ "Критерій ADR-значущості" (5-пунктовий
  чекліст з `clarify.md` п.6) в `.specify/constitution.md`
- [ ] T-308: `git diff --stat .specify/constitution.md` — підтвердити лише
  append, жоден з інваріантів 1-6 не редагувався
- [ ] T-309: Версія конституції → 1.2.0 в заголовку
