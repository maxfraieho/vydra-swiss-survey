...
Виконай Шаблон 4 ("🔌 Інтеграція Зовнішнього Сервісу / API") з `docs/sdd-development-methodology.md` для: $ARGUMENTS

1. Прочитай `docs/sdd-development-methodology.md`, розділ "ШАБЛОН 4", і виконай його крок за кроком.
