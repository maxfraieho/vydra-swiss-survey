...
Виконай Шаблон 1 ("🎨 Нова Фіча") з `docs/sdd-development-methodology.md` для задачі: $ARGUMENTS

1. Прочитай `docs/sdd-development-methodology.md`, розділ "ШАБЛОН 1", і виконай його буквально крок за кроком — не вигадуй власну послідовність.
